    ...
    <div className="flex h-screen bg-gray-100">
      ...
      <div className={`bg-[#1E293B] text-white h-full transition-all duration-300 ${isSidebarOpen ? "w-64" : "w-20"} flex flex-col`}>
        ...
        <nav className="flex flex-col mt-4 space-y-2 px-4">
          <SidebarLink href="/AdminDashboard" icon={<FaGavel size={20} />} text="Pending Birds" isSidebarOpen={isSidebarOpen} />
          <SidebarLink href="/AdminDashboard/AllBirds" icon={<FaList size={20} />} text="All Birds" isSidebarOpen={isSidebarOpen} />
